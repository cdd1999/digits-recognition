...
if not os.path.exists("data"):
    os.makedirs("data")
    os.makedirs("data/trainSet")
    os.makedirs("data/testSet")
    os.makedirs("data/trainSet/0")
    os.makedirs("data/trainSet/1")
    os.makedirs("data/trainSet/2")
    os.makedirs("data/trainSet/3")
    os.makedirs("data/trainSet/4")
    os.makedirs("data/trainSet/5")
    os.makedirs("data/testSet/0")
    os.makedirs("data/testSet/1")
    os.makedirs("data/testSet/2")
    os.makedirs("data/testSet/3")
    os.makedirs("data/testSet/4")
    os.makedirs("data/testSet/5")
